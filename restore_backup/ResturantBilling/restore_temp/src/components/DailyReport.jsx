    ...
    <div className="h-full flex flex-col bg-gradient-to-b from-slate-900 to-slate-800 animate-fade-in">
      ...
      <div className="grid grid-cols-2 gap-3 px-4 mb-4">
        <div className="bg-slate-700/50 rounded-2xl p-4 text-center">
          ...
          <p className="text-green-400 text-2xl font-bold">₹{totalCash}</p>
        </div>
        <div className="bg-slate-700/50 rounded-2xl p-4 text-center">
          <p className="text-gray-400 text-sm mb-1">📱 UPI</p>
          <p className="text-blue-400 text-2xl font-bold">₹{totalUpi}</p>
        </div>
        <div className="bg-slate-700/50 rounded-2xl p-4 text-center col-span-2">
          ...
          <p className="text-amber-400 text-3xl font-bold">₹{grandTotal}</p>
        </div>
      </div>
              ...
              <div className="flex justify-between items-start mb-2">
                <div>
                  ...
                  <span className={`ml-3 px-2 py-0.5 rounded-full text-xs font-bold ${
                    ...
                    {bill.paymentMethod === 'cash' ? '💵 Cash' : '📱 UPI'}
                  </span>
